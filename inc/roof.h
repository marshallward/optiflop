...
void roof_diff_simd(int, double, double, double *, double *, struct roof_args *);
void roof_mean(int, double, double, double *, double *, struct roof_args *);
...
void roof_demo(int, double, double, double *, double *, struct roof_args *);
